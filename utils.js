const domain = "https://staybooking-327703.uc.r.appspot.com";
...
export const getReservations = () => {
  // localStorage is a key-value map object provided by web browser and used for storing the data that should be maintained by users' browser;
